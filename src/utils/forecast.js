    ...
    request({ url, json: true }, (error, {body}) => {
        if (error) {
            ...
            callback(undefined, {
                ...
                d1: convertTime(body.daily[1].dt), // Today + 1
                ...
                d2: convertTime(body.daily[2].dt), // Today + 2
                ...
                d3: convertTime(body.daily[3].dt), // Today + 3
                ...
                d4: convertTime(body.daily[4].dt), // Today + 4
                ...
                d5: convertTime(body.daily[5].dt), // Today + 5
                ...
                d6: convertTime(body.daily[6].dt), // Today + 6
                ...
                d7: convertTime(body.daily[7].dt), // Today + 7
